...
namespace MongoDB.Driver
{
    ...
    public class MongoServer
    {
        ...
        internal IReadBindingHandle GetReadBinding(ReadPreference readPreference, IClientSessionHandle session)
        {
            ...
            {
                return new ReadWriteBindingHandle(new WritableServerBinding(_cluster, session.CoreSession.Fork()));
            }
            else
            {
                return new ReadBindingHandle(new ReadPreferenceBinding(_cluster, readPreference, session.CoreSession.Fork()));
            }
