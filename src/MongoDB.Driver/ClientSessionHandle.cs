...
namespace MongoDB.Driver
{
    ...
    internal sealed class ClientSessionHandle : WrappingClientSession, IClientSessionHandle
    {
        ...
        public ClientSessionHandle(IClientSession session)
            : this(new ReferenceCountedClientSession(Ensure.IsNotNull(session, nameof(session))))
        {
        }
        ...
        /// Initializes a new instance of the <see cref="ClientSessionHandle"/> class.
        /// </summary>
        /// <param name="wrapped">The wrapped reference counted session.</param>
