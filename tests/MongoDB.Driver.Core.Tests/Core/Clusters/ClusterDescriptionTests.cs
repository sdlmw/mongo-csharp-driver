...
namespace MongoDB.Driver.Core.Clusters
{
    public class ClusterDescriptionTests
    {
        ...
        [InlineData(1, 2, 2)]
        [InlineData(2, 1, 1)]
        public void LogicalSessionTimeout_should_return_expected_result_with_2_servers_when_one_is_not_connected(int? timeout1, int? timeout2, int? expectedResultMinutes)
        {
            var clusterId = new ClusterId(1);
            var connectionMode = ClusterConnectionMode.Automatic;
            var type = ClusterType.ReplicaSet;
        ...
        [InlineData(1, 2, 2)]
        [InlineData(2, 1, 1)]
        public void LogicalSessionTimeout_should_return_expected_result_with_2_servers_when_one_is_unknown_type(int? timeout1, int? timeout2, int? expectedResultMinutes)
        {
            var clusterId = new ClusterId(1);
            var connectionMode = ClusterConnectionMode.Automatic;
            var type = ClusterType.ReplicaSet;
